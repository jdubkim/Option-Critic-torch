...
class OptionCritic(nn.Module):
    def __init__(self,
        ...
        # )
        self.features = nn.Sequential(
            nn.Conv2d(self.in_channels, 64, kernel_size=4, stride=2),
            nn.ReLU(),
        ...
        self.Q = nn.Linear(1024, num_options) # Policy-Over-Options
        self.terminations = nn.Linear(1024, num_options) # Option-Termination
        self.options_W = nn.Parameter(torch.zeros(num_options, 1024, num_actions))
